...
class Inspiry_Stripe_Payments {
	...
	private function define_admin_hooks() {
		...
		add_filter( 'plugin_action_links_' . ISP_PLUGIN_BASENAME, [ $this, 'plugin_action_links' ] );
	...
	public function plugin_action_links( $links ) {
		$settings_link      = sprintf( '<a href="%1$s">%2$s</a>', admin_url( 'admin.php?page=inspiry-stripe-payments-settings' ), esc_html__( 'Settings', 'inspiry-stripe-payments' ) );
		$documentation_link = sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://realhomes.io/documentation/inspiry-stripe-payments/', esc_html__( 'Documentation', 'inspiry-stripe-payments' ) );
